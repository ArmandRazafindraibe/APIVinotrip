        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idroute = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    titreroute = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dateheurepanier = table.Column<DateTime>(type: "date", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    datenaissanceclient = table.Column<DateTime>(type: "date", nullable: true),
                    motdepasseclient = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    offrespromotionnellesclient = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    datederniereactiviteclient = table.Column<DateTime>(type: "date", nullable: true),
                    a2f = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    telephoneclient = table.Column<string>(type: "character(12)", fixedLength: true, maxLength: 12, nullable: true),
                    ...
                    datecreationtoken = table.Column<DateTime>(type: "date", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "categorieparticipant",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    numerocbclient = table.Column<string>(type: "character(50)", fixedLength: true, maxLength: 50, nullable: true),
                    fincodecarte = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    dateexpirationcreditcard = table.Column<DateTime>(type: "date", fixedLength: true, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idclient = table.Column<int>(type: "integer", nullable: true),
                    dateavis = table.Column<DateTime>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idcommande = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    idcodepromo = table.Column<int>(type: "integer", maxLength: 20, nullable: true),
                    ...
                    datecommande = table.Column<DateTime>(type: "date", nullable: true, defaultValueSql: "'2025-01-01'::date")
                },
                constraints: table =>
                {
